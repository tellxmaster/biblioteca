...
class MemberCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('address');
        CRUD::column('phone');
        CRUD::column('membership_number');
        CRUD::column('membership_start_date');
        CRUD::column('membership_expiry_date');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('address');
        CRUD::field('phone');
        CRUD::field('membership_number');
        CRUD::field('membership_start_date');
        CRUD::field('membership_expiry_date');
